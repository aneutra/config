...
pacicon:set_image("/home/pakdekro/.config/awesome/icons/pacman.png")
...
vicious.register(pacwidget, vicious.widgets.pkg,
  function(widget, args)
    if args[1] > 0 then
      pacicon:set_image("/home/pakdekro/.config/awesome/icons/pacman-open.png")
    else
      pacicon:set_image("/home/pakdekro/.config/awesome/icons/pacman.png")
    end
  ...
  function(widget, args)
    ...
    if args[1] == "-" then
      ...
      elseif bat_charge > 30 then
        baticon:set_image("/home/pakdekro/.config/awesome/icons/bat-low.png")
      elseif bat_charge > 10 then
        baticon:set_image("/home/pakdekro/.config/awesome/icons/bat-empty.png")
      else
        baticon:set_image("/home/pakdekro/.config/awesome/icons/bat-empty.png")
      end
    else
      baticon:set_image("/home/pakdekro/.config/awesome/icons/ac.png")
      if args[1] == "+" then
        blink = not blink
        if blink then
          baticon:set_image("/home/pakdekro/.config/awesome/icons/ac.png")
