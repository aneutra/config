...
tags = {
  names  = { "term", "net", "im", "media", "fm", "garbage" },
  layout = { layouts[1], layouts[1], layouts[4], layouts[1], layouts[1],
...
clockicon:set_image("/home/pakdekro/.config/awesome/icons/clock.png")
...
dash:set_markup("-")
--arrowleft = wibox.widget.textbox()
--arrowleft:set_markup("<")

-- Volume Widget
-- volicon = wibox.widget.imagebox()
-- volicon:set_image("/home/pakdekro/.config/awesome/icons/vol.png")
...
-- baticon:set_image("/home/pakdekro/.config/awesome/icons/bat.png")
-- -- Initialize widget
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "Print", function () awful.util.spawn("scrot /home/pakdekro/Pictures/screenshots/%Y-%m-%d-%T-screenshot.png") end),
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.util.spawn_with_shell("urxvt") end),
